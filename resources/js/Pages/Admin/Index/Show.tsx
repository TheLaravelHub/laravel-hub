        ...
        >
            <Head title={`Indexes | Show: ${index.name}`} />
                ...
                <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
                    <div className="w-full px-4 pt-4 flex items-center justify-between mb-4">
                        <h1 className="text-2xl font-semibold">Show: {index.name}</h1>
                        ...
                        <div className="p-6 text-gray-900 dark:text-gray-100">
                                <div className="grid grid-cols-8 gap-4">
                                    <div className="col-span-8">
                                        <Card>
                                            <CardHeader>
                                                <CardTitle className="text-2xl">Basic Data</CardTitle>
                                            </CardHeader>
                                            <CardContent className="flex flex-col justify-between gap-4">
                                                <div className="flex justify-between gap-4">
                                                    ...
                                                    <div className="flex flex-col gap-1">
                                                        <span>Slug</span>
                                                        <span className="font-bold">{index.slug}</span>
                                                    </div>
                                                </div>
                                                <div className="flex flex-col gap-1">
                                                    <span>Description</span>
                                                    <span className="font-bold">{index.description}</span>
                                                </div>
                                            </CardContent>
                                        </Card>
                                    </div>
                                            ...
                                            <CardContent className="flex flex-col justify-between gap-4">
                                                <div className="flex justify-between gap-4">
                                                    ...
                                                    <div className="flex flex-col gap-1">
                                                        ...
                                                        } className={`w-12 h-12 rounded`}></span>
                                                    </div>
                                                </div>
                                            </CardContent>
                                        </Card>
