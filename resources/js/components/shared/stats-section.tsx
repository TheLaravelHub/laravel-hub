            ...
            >
                ...
                <div className="grid grid-cols-3 gap-3 md:gap-6">
                    {stats.map((stat, index) => (
                        ...
                        >
                            <div className={`mb-2 rounded-full bg-gradient-to-r ${stat.color} ${compact ? 'p-2' : 'p-4'} text-white`}>
                                {stat.icon}
                            </div>
                            <motion.span
                                className={compact ? "text-xl font-bold md:text-2xl" : "text-3xl font-bold md:text-4xl"}
                            ...
                            <span className={`mt-1 text-muted-foreground ${compact ? 'text-xs md:text-sm' : 'text-sm md:text-base'}`}>
                                {stat.label}
                            </span>
                        </motion.div>
                    ))}
