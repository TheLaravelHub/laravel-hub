;(() => {
    var Z = Object.create,
        ...
        ie = (s, n) => () => (
            n || ((n = { exports: {} }), s(n.exports, n)), n.exports
        ),
        oe = (s, n, p) => {
                ...
                function v(e) {
                    ...
                    function j(r, o, l, i, u, m) {
                        ...
                        for (
                            ...
                            if (
                                ...
                                ;(Q || W) && t._callbacks[r].splice(f, 1),
                                    A.push(_)
                            }
                        return A
                    }
                    function x(r, o, l, i) {
                        t.stopCallback(o, o.target || o.srcElement, l, i) ||
                            (r(o, l) === !1 && (B(o), H(o)))
                    }
                    t._handleKey = function (r, o, l) {
                        ...
                        for (u = 0; u < i.length; ++u)
                            i[u].seq && (f = Math.max(f, i[u].level))
                        for (u = 0; u < i.length; ++u) {
                            if (i[u].seq) {
                                if (i[u].level != f) continue
                                ;(_ = !0),
                                    (m[i[u].seq] = 1),
                                    x(i[u].callback, l, i[u].combo, i[u].seq)
                                continue
                            }
    ...
    var le = (s) => {
            s.directive(
                'mousetrap',
                (n, { modifiers: p, expression: d }, { evaluate: M }) => {
                    let h = () => (d ? M(d) : n.click())
