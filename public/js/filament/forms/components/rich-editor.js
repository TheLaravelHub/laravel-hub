var po = '2.1.12',
    ...
    Lr = { ADD_ATTR: ['language'], SAFE_FOR_XML: !1, RETURN_DOM: !0 },
    m = {
    ...
    fo = [m.bytes, m.KB, m.MB, m.GB, m.TB, m.PB],
    Dr = {
        prefix: 'IEC',
        precision: 2,
        formatter(i) {
    ...
    he = function (i) {
        ...
        return (
            s.initEvent(i, e, n), r != null && Nr.call(s, r), o.dispatchEvent(s)
        )
    },
    Ir = function (i, t) {
    ...
    fi = (i) => document.activeElement !== i && kt(i, document.activeElement),
    kt = function (i, t) {
        if (i && t)
            for (; t; ) {
                if (t === i) return !0
    ...
    Vt = (i) => vo(i) && i?.data === 'block',
    vo = (i) => i?.nodeType === Node.COMMENT_NODE,
    zt = function (i) {
        let { name: t } =
            arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}
        if (i)
...
var So = 0,
    ...
    Br = /Mac|^iP/.test(navigator.platform)
        ? (i) => i.metaKey
        : (i) => i.ctrlKey,
    Ai = (i) => setTimeout(i, 1),
    _r = function () {
...
var lr = U([
    ...
    Ve = (function i() {
        ...
        let {
            ...
            Oi = null,
            Fi = b({}, ['audio', 'video', 'img', 'source', 'image', 'track']),
            An = null,
            Pi = b({}, [
                'alt',
                'class',
                ...
                if (!Wt || Wt !== a) {
                    if (
                        ...
                        Bt &&
                            ...
                            Bt.svgFilters === !0 &&
                                (b(N, Mn), b(O, _n), b(O, Ie)),
                            Bt.mathMl === !0 && (b(N, Bn), b(O, hr), b(O, Ie))),
                        a.ADD_TAGS &&
                            (N === ki && (N = St(N)), b(N, a.ADD_TAGS, I)),
                        a.ADD_ATTR &&
                            (O === Ri && (O = St(O)), b(O, a.ADD_ATTR, I)),
...
var is = 'style href src width height language class'.split(' '),
    ...
    be = class extends dt {
        ...
        getClassName() {
            ...
            return (
                e && t.push(''.concat(pt.attachment, '--').concat(e)),
                t.join(' ')
            )
        }
        getData() {
        ...
        getCaptionConfig() {
            ...
            let e = this.attachment.getType(),
                n = _r(
                    (t = mi[e]) === null || t === void 0 ? void 0 : t.caption,
                )
            ...
            if (this.block.isEmpty()) t.push(p('br'))
                ...
                let n =
                        ...
                        e === void 0
                            ? void 0
                            : e.text,
                    r = this.findOrCreateCachedChildView(qe, this.block.text, {
                        textConfig: n,
                    })
        ...
        increaseNestingLevel() {
            ...
            if (t) {
                let e = this.attributes.lastIndexOf(t),
                    n = vi(this.attributes, e + 1, 0, ...br(t))
                return this.copyWithAttributes(n)
            }
            return this
        }
...
`)
        ...
        appendBlockForElement(t) {
            let e = this.isBlockElement(t),
                n = kt(this.currentBlockElement, t)
                            ...
                            this.attachment.isPreviewable() &&
                                o.appendChild(
                                    p({
                                        tagName: 'div',
                                        className:
                                            Et.attachmentMetadataContainer,
                                        childNodes: p({
                                            tagName: 'span',
