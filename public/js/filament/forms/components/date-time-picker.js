        ...
        return function (m, Y, L) {
            ...
            D.parse = function (g) {
                ...
                if (typeof x == 'string') {
                    ...
                    for (var v = x.length, h = 1; h <= v; h += 1) {
                        q[1] = x[h - 1]
                        var c = L.apply(this, q)
                        if (c.isValid()) {
    ...
    ;(function (n, t) {
        ...
        return function (n, t, s) {
            var i = t.prototype,
                ...
                r = function (d, _, y, l, f) {
                    var m = d.name ? d : d.$locale(),
                        Y = e(m[_]),
                        L = e(m[y]),
                        D =
                            Y ||
        ...
        return function (s, i, e) {
            ...
            ;(o.tz = function (_, y) {
                ...
                var l,
                    f = this.utcOffset(),
                    m = this.toDate(),
                    Y = m.toLocaleString('en-US', { timeZone: _ }),
                    L = Math.round((m - new Date(Y)) / 1e3 / 60),
                    D = 15 * -Math.round(m.getTimezoneOffset() / 15) - L
                ...
                (o.offsetName = function (_) {
                    var y = this.$x.$timezone || e.tz.guess(),
                        l = a(this.valueOf(), y, { timeZoneName: _ }).find(
                            function (f) {
            ...
            ;(o.startOf = function (_, y) {
                ...
                var l = e(this.format('YYYY-MM-DD HH:mm:ss:SSS'), {
                    locale: this.$L,
                })
        ...
        return (
                ...
                var r = this,
                    ...
                    d = function (D, w) {
                        ...
                        return z.w(
                            r
                                .toDate()
                                [D].apply(r.toDate('s'), (a ? g : C).slice(w)),
                            r,
                        )
                    },
                    _ = this.$W,
            ...
            (t.$set = function (i, e) {
                var r,
                    ...
                    (r[_e] = u + 'Milliseconds'),
                    r)[a],
                    d = a === V ? this.$D + (e - this.$W) : e
                if (a === R || a === K) {
                    var _ = this.clone().set(se, 1)
                    _.$d[o](d),
                        _.init(),
                        (this.$d = _.set(
                            se,
            ...
            (t.add = function (i, e) {
                ...
                if (u === oe) return o(7)
                var d =
                        ((a = {}), (a[ne] = ce), (a[ie] = ge), (a[te] = ae), a)[
                            u
                        ] || 1,
                    _ = this.$d.getTime() + i * d
                return z.w(_, this)
            }),
            ...
            (t.diff = function (i, e, r) {
                var a = this,
                    u = z.p(e),
                    o = F(i),
                    d = (o.utcOffset() - this.utcOffset()) * ce,
                    _ = this - o,
                    y = function () {
                        return z.m(a, o)
                    },
...
function Ni({
    ...
    return {
        ...
        getDayLabels: function () {
            let u = O.weekdaysShort()
            return t === 0 ? u : [...u.slice(t), ...u.slice(0, t)]
        },
        getMaxDate: function () {
            let u = O(this.$refs.maxDate?.value)
            return u.isValid() ? u : null
        },
        getMinDate: function () {
            let u = O(this.$refs.minDate?.value)
            return u.isValid() ? u : null
        },
