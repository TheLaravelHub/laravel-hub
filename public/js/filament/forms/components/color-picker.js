    ...
    v = (e) => (
        ...
        e.length < 6
            ...
            : {
                  ...
                  a:
                      e.length === 8
                          ? n(parseInt(e.substring(6, 8), 16) / 255, 2)
                          : 1,
              }
    ),
    ...
    update(t) {
        ;(this.hsva = t),
            ...
            this.el.setAttribute(
                'aria-valuetext',
                `Saturation ${n(t.s)}%, Brightness ${n(t.v)}%`,
            )
    }
    getMove(t, r) {
        return {
...
var k = class extends u {
    ...
    update(t) {
        ...
        let a = n(s)
        this.el.setAttribute('aria-valuenow', `${a}`),
            this.el.setAttribute('aria-valuetext', `${a}%`)
    }
    getMove(t, r) {
...
function gt({
    ...
    return {
        ...
        setState: function (l) {
            ;(this.state = l),
                (this.$refs.input.value = l),
                (this.$refs.panel.color = l)
        },
        isOpen: function () {
