...
function Fo(i, t, e) {
    ...
    D(s) && D(n)
        ? Xt(s, n)
        : Object.prototype.hasOwnProperty.call(t, i) || (t[i] = He(n))
}
    ...
    if (i._sorted) {
        ...
        d &&
            (n = Y(
                Math.min(
                    at(r, a.axis, c).lo,
                    e ? s : at(t, l, a.getPixelForValue(c)).lo,
                ),
                0,
                s - 1,
            )),
            u
                ? (o =
                      Y(
                          Math.max(
                              at(r, a.axis, h, !0).hi + 1,
                              e
                                  ? 0
                                  : at(t, l, a.getPixelForValue(h), !0).hi + 1,
                          ),
                          n,
                          s,
                      ) - n)
...
var ze = (i) => i === 0 || i === 1,
    As = (i, t, e) =>
        -(Math.pow(2, 10 * (i -= 1)) * Math.sin(((i - t) * F) / e)),
    ...
    Ht = {
        ...
        easeInOutElastic(i) {
            return ze(i)
                ? i
                : i < 0.5
                  ? 0.5 * As(i * 2, 0.1125, 0.45)
                  : 0.5 + 0.5 * Ts(i * 2 - 1, 0.1125, 0.45)
        },
        easeInBack(i) {
        ...
        easeInOutBounce: (i) =>
            i < 0.5
                ? Ht.easeInBounce(i * 2) * 0.5
                : Ht.easeOutBounce(i * 2 - 1) * 0.5 + 0.5,
    }
function be(i) {
    return (i + 0.5) | 0
}
    ...
    for (l = 0; l < r; l++)
        if (((d = e[l]), d != null && I(d) !== !0)) a = pe(i, n, o, a, d)
            ...
            for (c = 0, h = d.length; c < h; c++)
                (u = d[c]), u != null && !I(u) && (a = pe(i, n, o, a, u))
    i.restore()
    let f = o.length / 2
    if (f > e.length) {
...
function Yi(i, t, e, s, n) {
    ...
    if (!(isNaN(f) || f <= 0)) {
        switch ((i.beginPath(), d)) {
            default:
                n ? i.ellipse(e, s, n / 2, f, 0, 0, F) : i.arc(e, s, f, 0, F),
                    i.closePath()
                break
            case 'triangle':
            ...
            case 'dash':
                i.moveTo(e, s),
                    i.lineTo(e + Math.cos(g) * f, s + Math.sin(g) * f)
                break
        }
...
function wa(i, t, e, s) {
    let n
    for (let o of t)
        if (((n = fn(ma(o, i), e)), J(n))) return Ki(i, n) ? qi(e, s, i, n) : n
}
function fn(i, t) {
    for (let e of t) {
        if (!e) continue
...
function Gi(i, t, e, s) {
    let { iScale: n } = i,
        ...
        h
    for (r = 0, l = s; r < l; ++r)
        (c = r + e), (h = t[c]), (a[r] = { r: n.parse(gt(h, o), c) })
    return a
}
    ...
    for (e = 0, s = i.length; e < s; ++e)
        (a = o),
            ...
            o &&
                ((n = i[e]),
                a &&
                    ((n.cp1x = Ne(n.cp1x, t.left, t.right)),
                    (n.cp1y = Ne(n.cp1y, t.top, t.bottom))),
                r &&
                    ((n.cp2x = Ne(n.cp2x, t.left, t.right)),
                    (n.cp2y = Ne(n.cp2y, t.top, t.bottom))))
}
...
function is(i, t, e) {
    ...
    return (
        m !== null &&
            g.push(Vs({ start: m, end: d, loop: u, count: a, style: f })),
        g
    )
}
function ss(i, t) {
...
O.set('animations', {
    colors: { type: 'color', properties: Xa },
    numbers: { type: 'number', properties: Ya },
})
...
function Cn(i, t) {
    ...
    for (let f = 0; f < d; ++f) {
        ...
        ;(u = b[c] = er(n, h, p)),
            (u[r] = m),
            (u._top = Pn(u, a, !0, s.type)),
            (u._bottom = Pn(u, a, !1, s.type))
    }
}
function ns(i, t) {
    let e = i.scales
...
var os = (i) => i === 'reset' || i === 'none',
    ...
    nr = (i, t, e) =>
        i && !t.hidden && t._stacked && { keys: go(e, !0), values: null },
    et = class {
        constructor(t, e) {
            ;(this.chart = t),
                (this._ctx = t.ctx),
        ...
        _dataCheck() {
            ...
            if (D(e)) this._data = Ja(e)
                ...
                e && Object.isExtensible(e) && Js(e, this),
                    (this._syncList = []),
                    (this._data = e)
            }
        }
        ...
        _update(t) {
            ...
            this.update(t || 'default'),
                (e._clip = Za(
                    C(
                        this.options.clip,
                        Ga(e.xScale, e.yScale, this.getMaxOverflow()),
                    ),
                ))
        }
        update(t) {}
        draw() {
            let t = this._ctx,
                ...
                h
            for (
                s.dataset && s.dataset.draw(t, o, r, l), h = r;
                h < r + l;
                ++h
            ) {
                let d = n[h]
        ...
        _resolveElementOptions(t, e = 'default', s) {
            ...
            return (
                p.$shared &&
                    ((p.$shared = l), (o[a] = Object.freeze(Dn(p, l)))),
                p
            )
        }
...
function ar(i) {
    let t = i.iScale,
        ...
        l = () => {
            a === 32767 ||
                a === -32768 ||
                (J(r) && (s = Math.min(s, Math.abs(a - r) || s)), (r = a))
        }
...
var te = class extends et {
    ...
    parseObjectData(t, e, s, n) {
        ...
        for (u = s, f = s + n; u < f; ++u)
            (p = e[u]),
                (g = {}),
                (g[o.axis] = o.parse(gt(p, c), u)),
                d.push(po(gt(p, h), g, a, u))
        return d
    }
    updateRangeFromParsed(t, e, s, n) {
        ...
        for (let f = e; f < e + s; f++) {
            let g = this.getParsed(f),
                ...
                _ = {
                    ...
                    base: p.base,
                    enableBorderRadius:
                        !b || as(g._custom) || a === b._top || a === b._bottom,
                    x: c ? p.head : m.center,
                    y: c ? m.center : p.head,
...
function pr(i, t, e) {
    ...
    if (t < F) {
        let r = i,
            ...
            u = Math.sin(l),
            f = (v, y, x) =>
                Kt(v, r, l, !0) ? 1 : Math.max(y, y * e, x, x * e),
            g = (v, y, x) =>
                Kt(v, r, l, !0) ? -1 : Math.min(y, y * e, x, x * e),
            p = f(0, c, d),
            m = f(V, h, u),
            b = g(B, c, d),
            _ = g(B + V, h, u)
    ...
    updateElements(t, e, s, n) {
        ...
        for (_ = e; _ < e + s; ++_) {
            ...
            m &&
                (x.options =
                    p ||
                    this.resolveDataElementOptions(_, y.active ? 'active' : n)),
                (b += v),
...
var se = class extends et {
    ...
    updateElements(t, e, s, n) {
        ...
        for (g = e; g < e + s; g++) {
            let m = t[g],
                ...
                v = a.getDataVisibility(g)
                    ? c.getDistanceFromCenterForValue(this.getParsed(g).r)
                    : 0
            ;(f = _),
                o && (l.animateScale && (v = 0), l.animateRotate && (b = _ = u))
            let y = {
                x: h,
                y: d,
                innerRadius: 0,
    ...
    _computeAngle(t, e, s) {
        return this.chart.getDataVisibility(t)
            ? nt(this.resolveDataElementOptions(t, e).angle || s)
            : 0
    }
}
se.id = 'polarArea'
...
function br(i, t) {
    ...
    if (o > 0) {
        ...
        for (ii(t, l, c, T(u) ? 0 : a - u, a), h = 0, d = o - 1; h < d; h++)
            ii(t, l, c, n[h], n[h + 1])
...
var Ft = class i extends it {
        ...
        getContext(t) {
            ...
            return (
                this.$context ||
                (this.$context = Pr(this.chart.getContext(), this))
            )
        }
        _tickSize() {
        ...
        drawBorder() {
            ...
            let a = s.setContext(this.getContext(0)).lineWidth,
                ...
                d
            this.isHorizontal()
                ? ((l = Mt(t, this.left, o) - o / 2),
                  (c = Mt(t, this.right, a) + a / 2),
                  (h = d = r))
                : ((h = Mt(t, this.top, o) - o / 2),
                  (d = Mt(t, this.bottom, a) + a / 2),
                  (l = c = r)),
                e.save(),
        ...
        drawTitle() {
            ...
            e === 'bottom' || e === 'center' || D(e)
                ? ((l += a.bottom),
                  I(s.text) && (l += o.lineHeight * (s.text.length - 1)))
                : (l += a.top)
            let {
                titleX: c,
                titleY: h,
    ...
    Qt = class {
        ...
        register(t) {
            ...
            return (
                o in n ||
                    ((n[o] = t),
                    Ar(t, a, s),
                    this.override && O.override(t.id, t.overrides)),
                a
            )
        }
        get(t) {
        ...
        unregister(t) {
            ...
            s in e && delete e[s],
                n &&
                    s in O[n] &&
                    (delete O[n][s], this.override && delete vt[s])
        }
    }
function Ar(i, t, e) {
    let s = jt(Object.create(null), [e ? O.get(e) : {}, O.get(t), i.defaults])
    O.set(t, s),
        i.defaultRoutes && Tr(t, i.defaultRoutes),
        i.descriptors && O.describe(t, i.descriptors)
}
function Tr(i, t) {
...
var ps = class {
    ...
    oe = class extends et {
        ...
        addElements() {
            ...
            !this.datasetElementType &&
                t &&
                (this.datasetElementType = ht.getElement('line')),
                super.addElements()
        }
        updateElements(t, e, s, n) {
            let o = n === 'reset',
...
function Se(i, t, e, s) {
    ...
    for (o = 0, a = i.length, c = 0; o < a; ++o) {
        ;(r = i[o]),
            (l = r.box),
            l.update(r.width || t.w, r.height || t.h, Xr(r.horizontal, t))
...
function Bn(i, t, e, s) {
    ...
    for (let r of i) {
        ...
        if (r.horizontal) {
            ...
            J(c.start) && (a = c.start),
                l.fullSize
                    ? si(l, n.left, a, e.outerWidth - n.right - n.left, u)
                    : si(l, t.left + c.placed, a, d, u),
                (c.start = a),
                (c.placed += d),
                (a = l.bottom)
        } else {
            ...
            J(c.start) && (o = c.start),
                l.fullSize
                    ? si(l, o, n.top, u, e.outerHeight - n.bottom - n.top)
                    : si(l, o, t.top + c.placed, u, d),
                (c.start = o),
                (c.placed += d),
                (o = l.right)
        }
...
function Jr(i, t, e) {
    let s = i.canvas,
        n = new MutationObserver((o) => {
            let a = !1
            for (let r of o)
                (a = a || di(r.addedNodes, s)),
                    (a = a && !di(r.removedNodes, s))
            a && e()
        })
...
var bs = class extends hi {
    ...
    removeEventListener(t, e) {
        let s = t.$proxies || (t.$proxies = {}),
            n = s[e]
        if (!n) return
        ;(({ attach: cs, detach: cs, resize: cs })[e] || Gr)(t, e, n),
            (s[e] = void 0)
    }
    getDevicePixelRatio() {
...
function ys(i, t) {
    return i === 'x' || i === 'y'
        ? i
        : t.axis || dl(t.position) || i.charAt(0).toLowerCase()
}
function ul(i, t) {
    ...
    return (
        Object.keys(s).forEach((r) => {
            ...
            let c = ys(r, l),
                ...
                d = e.scales || {}
            ;(o[c] = o[c] || r),
                (a[r] = Xt(Object.create(null), [{ axis: c }, l, d[c], d[h]]))
        }),
...
var gl = (i) =>
    D(i) && Object.getOwnPropertyNames(i).reduce((t, e) => t || ft(i[e]), !1)
function pl(i, t) {
...
var It = class {
        constructor(t, e) {
            ...
            ;(this.platform = new (s.platform || nl(n))()),
            ...
            e &&
                ...
                E(o, (a) => {
                    let r = a.options,
                        ...
                        h = C(r.type, a.dtype)
                    ;(r.position === void 0 ||
                        jn(r.position, c) !== jn(a.dposition)) &&
        ...
        _checkEventBindings() {
            let t = this.options,
                ...
                s = new Set(t.events)
            ;(!Oi(e, s) || !!this._responsiveListeners !== t.responsive) &&
        ...
        getContext() {
            return (
                this.$context ||
                (this.$context = pt(null, { chart: this, type: 'chart' }))
            )
        }
        ...
        _eventHandler(t, e) {
            let s = {
                ...
                n = (a) =>
                    (a.options.events || this.options.events).includes(
                        t.native.type,
                    )
        ...
        _handleEvent(t, e, s) {
            ...
            s &&
                ((this._lastEvent = null),
                z(o.onHover, [t, r, this], this),
                l && z(o.onClick, [t, r, this], this))
            let h = !me(r, n)
            return (
                (h || e) &&
                    ((this._active = r), this._updateHoverStyles(r, n, e)),
                (this._lastEvent = c),
                h
            )
        }
...
function Sl(i, t, e, s, n, o) {
    ...
    r &&
        (c
            ? ((i.lineWidth = r * 2), (i.lineJoin = l || 'round'))
            : ((i.lineWidth = r), (i.lineJoin = l || 'bevel')),
...
var dt = class extends it {
    ...
    get segments() {
        return (
            this._segments || (this._segments = vn(this, this.options.segment))
        )
    }
    first() {
        let t = this.segments,
    ...
    draw(t, e, s, n) {
        ...
        ;(this.points || []).length &&
            o.borderWidth &&
            (t.save(), El(t, this, s, n), t.restore()),
...
function Nl(i, t, e, s, n) {
    ...
    for (a[l++] = i[h], d = 0; d < o - 2; d++) {
        ...
        for (f = g = -1, _ = M; _ < w; _++)
            (g =
                0.5 *
                Math.abs((S - m) * (i[_].y - k) - (S - i[_].x) * (b - k))),
                g > f && ((f = g), (u = i[_]), (p = _))
        ;(a[l++] = u), (h = p)
    }
    return (a[l++] = i[c]), a
    ...
    for (a = t; a < t + e; ++a) {
        ...
        if (x === h)
            ...
            if (!T(d) && !T(u)) {
                let w = Math.min(d, u),
                    S = Math.max(d, u)
                w !== f && w !== M && m.push({ ...i[w], x: n }),
                    S !== f && S !== M && m.push({ ...i[S], x: n })
            }
            a > 0 && M !== f && m.push(i[M]),
                m.push(r),
                (h = x),
...
var hc = {
        ...
        afterDatasetsUpdate(i, t, e) {
            ...
            for (a = 0; a < s; ++a)
                (l = n[a]),
                    !(!l || l.fill === !1) && (l.fill = Ul(n, a, e.propagate))
        },
        beforeDraw(i, t, e) {
                ...
                l.setWidth(this.width),
                    y
                        ? S > 0 &&
                          ...
                          g.line++,
                          (A = g.x =
                              X(o, this.left + d, this.right - s[g.line])))
                        : S > 0 &&
                          H + M > this.bottom &&
        ...
        drawTitle() {
            ...
            if (this.isHorizontal())
                (u = Math.max(...this.lineWidths)),
                    (h = this.top + c),
                    (d = X(t.align, d, this.right - u))
            else {
                let g = this.columnSizes.reduce(
...
function eo(i, t) {
    let e = i.chart.ctx,
        ...
        m = 0,
        b = s.reduce(
            (y, x) => y + x.before.length + x.lines.length + x.after.length,
            0,
        )
    if (
        ...
        parse(t, e) {
            ...
            return (
                (e =
                    isFinite(e) && s[e] === t
                        ? e
                        : Cc(s, t, C(e, t), this._addedLabels)),
                Dc(e, s.length - 1)
            )
        }
        determineDataLimits() {
...
function Oc(i, t) {
    ...
    ;(k = Math.ceil(m / x) - Math.floor(p / x)),
        ...
        n === 'ticks'
            ? ((w = Math.floor(p / x) * x), (S = Math.ceil(m / x) * x))
            : ((w = p), (S = m)),
        b && _ && o && Us((r - a) / o, x / 1e3)
            ? ((k = Math.round(Math.min((r - a) / x, h))),
              (x = (r - a) / k),
              (w = a),
              (S = r))
            : v
              ? ((w = b ? a : w),
                ...
                (x = (S - w) / k))
              : ((k = (S - w) / x),
                Ut(k, Math.round(k), x / 1e3)
                    ? (k = Math.round(k))
                    : (k = Math.ceil(k)))
    let L = Math.max(Li(x), Li(w))
    ;(M = Math.pow(10, T(l) ? L : l)),
        (w = Math.round(w * M) / M),
        (S = Math.round(S * M) / M)
    let R = 0
    for (
        ...
        (u && w !== a
            ? (e.push({ value: a }),
              w < a && R++,
              Ut(Math.round((w + R * x) * M) / M, a, ao(a, y, i)) && R++)
            : w < a && R++);
        R < k;
        ++R
    )
...
var Re = class extends Ft {
    ...
    getLabelForValue(t) {
        return t === void 0
            ? '0'
            : Zt(t, this.chart.options.locale, this.options.ticks.format)
    }
    configure() {
        let t = this.min
        super.configure(),
            (this._startValue = tt(t)),
            (this._valueRange = tt(this.max) - tt(t))
    }
    getPixelForValue(t) {
        return (
            ...
            t === null || isNaN(t)
                ...
                : this.getPixelForDecimal(
                      t === this.min
                          ? 0
                          : (tt(t) - this._startValue) / this._valueRange,
                  )
        )
    }
    getValueForPixel(t) {
...
Re.id = 'logarithmic'
Re.defaults = {
    ticks: { callback: pi.formatters.logarithmic, major: { enabled: !0 } },
}
function Ss(i) {
    let t = i.ticks
...
function Tc(i, t, e) {
    return (
        (e = I(e) ? e : [e]),
        { w: rn(i, t.string, e), h: e.length * t.lineHeight }
    )
}
    ...
    for (let n = t - 1; n >= 0; n--) {
        ...
        if (!T(g)) {
            ...
            Object.values(p).some((x) => x !== 0)
                ? (e.beginPath(),
                  qt(e, { x: b, y: _, w: v, h: y, radius: p }),
                  e.fill())
                : e.fillRect(b, _, v, y)
        }
        wt(e, i._pointLabels[n], r, l + a.lineHeight / 2, a, {
            color: o.color,
            textAlign: c,
            textBaseline: 'middle',
        })
...
function ri(i, t, e) {
    ...
    e
        ? (t >= i[s].pos &&
              t <= i[n].pos &&
              ({ lo: s, hi: n } = at(i, 'pos', t)),
          ({ pos: o, time: r } = i[s]),
          ({ pos: a, time: l } = i[n]))
        : (t >= i[s].time &&
              t <= i[n].time &&
              ({ lo: s, hi: n } = at(i, 'time', t)),
          ({ time: o, pos: r } = i[s]),
          ({ time: a, pos: l } = i[n]))
    let c = a - o
